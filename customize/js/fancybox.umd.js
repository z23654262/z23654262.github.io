...
!function(t, e) {
                ...
                if (n < 2)
                    ...
                    if (o > n)
                        ...
                        for (var s = function(e) {
                            ...
                            i.setAttribute("title", t.carousel.localize("", [["%d", e + 1]])),
    ...
    Y.defaults = {
        ...
        key: "t",
        Carousel: {},
        tpl: '<div class="fancybox__thumb" style="background-image:url(\'\')"></div>'
    };
    var V = function(t, e) {
      ...
      , Z = {
        ...
        html5video: {
            tpl: '<video class="fancybox__html5video" playsinline controls controlsList="nodownload" poster="">\n  <source src="" type="" />Sorry, your browser doesn\'t support embedded videos.</video>',
            format: ""
        }
    }
      , G = function() {
        ...
        return s(t, [{
            ...
            value: function(t) {
                ...
                i.onreadystatechange = function() {
                    ...
                    200 === i.status ? e.setContent(t, i.responseText) : e.setError(t, 404 === i.status ? "" : ""))
                }
                ;
                var n = t.ajax || null;
            ...
            value: function(t) {
                if (t && !t.isDom) {
                    ...
                    case "html":
                        ...
                        break;
                    case "html5video":
                        this.fancybox.setContent(t, this.fancybox.option("Html.html5video.tpl").replace(/\{\{src\}\}/gi, t.src).replace("", t.format || t.html5video && t.html5video.format || "").replace("", t.poster || t.thumb || ""));
                        break;
                    case "inline":
                    case "clone":
      ...
      , rt = function(t) {
        ...
        return s(i, [{
            ...
            value: function(t, e) {
                ...
                i.innerHTML = this.localize(e || "<p></p>"),
                this.setContent(t, i, {
                    suffix: "error"
                })
            }
